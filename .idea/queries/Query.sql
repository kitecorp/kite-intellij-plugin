SELECT @start_date:=TIMESTAMP('2024-04-08') FROM DUAL;
SELECT @end_date:=TIMESTAMP('2024-04-14') + INTERVAL 1 DAY FROM DUAL;
SELECT
...
WHERE
  ...
  AND createdOn >= @start_date
  AND createdOn <= @end_date
UNION SELECT
                                             ...
                                             f.accountId IN (SELECT
                                                             ...
                                                             WHERE
                                                               ...
                                                               AND pr.name IN ('Free Plan Telcel' , 'Cloud MiMedia 25GB',
                                                                               ...
                                                                               'Cloud MiMedia 250GB',
                                                                               'Cloud MiMedia 1TB'))
                                           AND tf.createdOn >= @start_date
                                           AND tf.createdOn <= @end_date),
                                        0) + COALESCE((SELECT
                                                           SUM(fvi.byteCount)
                                                       FROM
                                                           ...
                                                           f.accountId IN (SELECT
                                                                           ...
                                                                           WHERE
                                                                             ...
                                                                             AND pr.name IN ('Free Plan Telcel' , 'Cloud MiMedia 25GB',
                                                                                             ...
                                                                                             'Cloud MiMedia 250GB',
                                                                                             'Cloud MiMedia 1TB'))
                                                         AND fvi.createdOn >= @start_date
                                                         AND fvi.createdOn <= @end_date),
                                                      0)) / 1000000000, 3)